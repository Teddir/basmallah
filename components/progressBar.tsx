    ...
    useEffect(() => {
      ...
      const handleMutation: MutationCallback = () => {
        ...
        validAnchorElements.forEach((anchor) => {
          anchor.addEventListener('click', (event) => handleAnchorClick(event as MouseEvent), true);
        });
      ...
      return () => {
        ...
        elementsWithAttachedHandlers.current.forEach((anchor) => {
          anchor.removeEventListener('click', (event) => handleAnchorClick(event as MouseEvent), true);
        });
